...
class bkViewController: UIViewController, UIScrollViewDelegate, communicationControllerPopup
{
    ...
    func landscapeOps(){
        ...
        if(hermiteScribbleView.currentStage == 1 ) {
            ...
            scrollView.contentOffset = CGPoint(x: screenSize.width * 5.0 , y: (scrollView.frame.height * 5))
